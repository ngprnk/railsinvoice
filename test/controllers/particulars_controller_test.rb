...
class ParticularsControllerTest < ActionController::TestCase
  ...
  test "should create particular" do
    assert_difference('Particular.count') do
      post :create, particular: { itemname: @particular.itemname, quantity: @particular.quantity, rate: @particular.rate }
    end
  ...
  test "should update particular" do
    patch :update, id: @particular, particular: { itemname: @particular.itemname, quantity: @particular.quantity, rate: @particular.rate }
    assert_redirected_to particular_path(assigns(:particular))
  end
